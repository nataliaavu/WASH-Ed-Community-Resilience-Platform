    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          //Thin yellow line below the AppBar
          ...
          child: Column(
            ...
            children: [
              ...
              kikoBox(
                ...
                screenWidth * 1,
                190,
                AssetImage('assets/kiko/WashEd_kiko_sprite_thumbs-up.png'),
              ),
              const SizedBox(height: 20),
              ...
              SizedBox(height: 20),
              Align(alignment: Alignment.center, child: Text("Our Sponsors")),
            ],
          ),
        ),
      ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const SizedBox(width: 10),
                    const Text("All Clear", style: TextStyle(fontSize: 16)),
                  ],
                ),
